...
log_dir = '/log_obc/'
dataset_dir = '/log_obc/prompt_scan_cut_train.json'
...
if __name__ == '__main__':
    ...
    trainer = pl.Trainer(gpus=4, max_epochs=40, strategy='ddp', default_root_dir=log_dir, callbacks=[logger, checkpoint_callback])
